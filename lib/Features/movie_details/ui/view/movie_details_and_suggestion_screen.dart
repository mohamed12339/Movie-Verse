...
import 'package:project_movie_app/Features/movie_details/ui/widgets/torrent_button.dart';
...
class _MovieDetailsAndSuggestionScreenState extends State<MovieDetailsAndSuggestionScreen> {
      ...
      body: BlocBuilder<MovieDetailsAndSuggestionCubit,
        ...
        builder: (context, state) {
          ...
          if (state.movieDetailsApi is ErrorApiResult ||
            ...
            return Center(child: Text('Error loading data' , style: TextStyle(color: AppColors.white),));
          }
          ...
          if (movie == null) {
            return  Center(child: Text('No movie data available' , style: TextStyle(color: AppColors.white)));
          }
              ...
              children: [
                  ...
                  children: [
                    ...
                    Positioned.fill(child: InkWell(
                      onTap:  movie.ytTrailerCode != null
                        ...
                        Navigator.push(
                          ...
                          : null,
                      child: Image.asset(
                        AppAssets.icWatch, height: 80, width: 80,),
                    )),
                    Positioned(
                      top: 40,
                      left: 10,
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                context,
                               AppRoute.watchList).then((_){
                                cubit.checkWatchlist(widget.movieId); /// دية معناها لما اجي بقا امسحها من ايكون ال delete في ال watchList خلاص كدا تتمسح من السكرينة دية بس
                              });
                            },
                          ),
                        ],
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(movie.title, style: AppStyles.white36Mid , textAlign: TextAlign.center,),
                          Text(movie.titleLong ?? '', style: AppStyles.white20regular ,textAlign: TextAlign.center,),
                          Text(movie.year.toString(),
                              style: AppStyles.white16Regular , textAlign: TextAlign.center,),
                        ],
                      ),
                    ),
                  ],
                    ...
                    onPressed: movie.ytTrailerCode != null
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => TorrentButton(
                            videoUrl:
                            "https://www.youtube.com/watch?v=${movie?.ytTrailerCode}", /// دا هايجيب اعلان الفيلم مش هاقدر اجيب الفيلم لازم بفلوس
                          ),
                        ),
                      );
                    }
                ...
                Center(
                  child: Row(
                      ...
                      children: [
                        buildRatingAndFavAndTimeItems(Icons.favorite , "${movie.likeCount}"),
                        SizedBox(width: 16),
                        buildRatingAndFavAndTimeItems(Icons.watch_later , "${movie.runtime}"),
                        SizedBox(width: 16),
                        buildRatingAndFavAndTimeItems(Icons.star , "${movie.rating}"),
                        SizedBox(width: 16),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Screen Shots', style: AppStyles.white24bold),
                       SizedBox(height: 10),
                      SizedBox(
                        height: MediaQuery.of(context).size.height * 0.4, ///  MediaQuery عشان عايز اخد جزء من الشاشة
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(12),
                                child: buildImage(shot, height: 200, width: double.infinity),
                              ),
                            );
                          },
                        ),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  AppRoute.movieDetails(suggestion.id),
                                );
                              },
                              child: Container(
                                decoration: BoxDecoration(
