...
class MovieDetailsUseCase {
  ...
  ///  دا عشان احمل الداتا الي هيا فيها بقا MovieDetails  الانا هاستخدمها  بس وعرفتلوا ال MovieDetailsRepository بتاعة ال domain ودا سبب اني بحط ال MovieDetailsRepository في ال domain عشان ال useCase
