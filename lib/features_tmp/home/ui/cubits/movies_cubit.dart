...
import 'package:project_movie_app/features_tmp/home/domain/use_cases/get_all_genres_use_case.dart';
import 'package:project_movie_app/features_tmp/home/domain/use_cases/get_movies_by_genre_use_case.dart';
import 'package:project_movie_app/features_tmp/home/domain/use_cases/get_movies_by_query_use_case.dart';
import 'package:project_movie_app/features_tmp/home/domain/use_cases/get_top_rated_movies_use_case.dart';
...
class MoviesCubit extends Cubit<MoviesState> {
  ...
  void getAllGenres() async {
    //try {
      ...
      if(result.hasData){
        getMoviesForAllGenres(result.myData.toList());
      //}
    // } on Exception catch (e) {
    //   emit(
